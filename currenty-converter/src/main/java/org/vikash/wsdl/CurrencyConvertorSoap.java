...
public interface CurrencyConvertorSoap {
	...
	/**
	 * <br>
	 * <b>Get conversion rate from one currency to another currency <b><br>
	 * <p>
	 * <b><font color='#000080' size='1' face='Verdana'><u>Differenct currency
	 * Code and Names around the world</u></font></b>
	 * </p>
	 * <blockquote>
	 * <p>
	 * <font face='Verdana' size='1'>AFA-Afghanistan Afghani<br>
	 * ALL-Albanian Lek<br>
	...
	@RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "org.vikash.wsdl.ConversionRate")
	@ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "org.vikash.wsdl.ConversionRateResponse")
	public double conversionRate(
			@WebParam(name = "FromCurrency", targetNamespace = "http://www.webserviceX.NET/") Currency fromCurrency,
			@WebParam(name = "ToCurrency", targetNamespace = "http://www.webserviceX.NET/") Currency toCurrency);
